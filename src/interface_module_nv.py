...
def nv_interface(master_window=None):
    ...
    def generate_replicates(replicates_number):
        ...
        zero_weight_label = tk.Label(nv_interface_window, text='Empty Cup (M0)')
        zero_weight_label.grid(row=initial_row, column=1, padx=25)
        sample_weight_label = tk.Label(nv_interface_window, text='Sample (M1)')
        sample_weight_label.grid(row=initial_row, column=2, padx=25)
        final_weight_label = tk.Label(nv_interface_window, text='Residue + Cup (M2)')
